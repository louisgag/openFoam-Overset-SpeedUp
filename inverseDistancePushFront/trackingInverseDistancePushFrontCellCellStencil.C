...
#include "trackingInverseDistancePushFrontCellCellStencil.H"
...
{
    defineTypeNameAndDebug(trackingInverseDistancePushFront, 0);
    addToRunTimeSelectionTable(cellCellStencil, trackingInverseDistancePushFront, mesh);
}
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

bool Foam::cellCellStencils::trackingInverseDistancePushFront::markBoundaries
(
    const fvMesh& mesh,
...
void Foam::cellCellStencils::trackingInverseDistancePushFront::markPatchesAsHoles
(
...
void Foam::cellCellStencils::trackingInverseDistancePushFront::markDonors
(
    PstreamBuffers& pBufs,
...
Foam::cellCellStencils::trackingInverseDistancePushFront::trackingInverseDistancePushFront
(
    const fvMesh& mesh,
...
:
    inverseDistancePushFront(mesh, dict, false),
...
bool Foam::cellCellStencils::trackingInverseDistancePushFront::update()
{
