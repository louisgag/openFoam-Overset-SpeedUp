...
namespace Foam
{
    defineTypeNameAndDebug(waveMethodIters, 0);
    addToRunTimeSelectionTable(meshToMeshMethod, waveMethodIters, components);
}

// * * * * * * * * * * * * * Private Member Functions  * * * * * * * * * * * //

void Foam::waveMethodIters::calculate
(
    const polyMesh& src,
    const polyMesh& tgt,
...
Foam::waveMethodIters::waveMethodIters
(
    const polyMesh& src,
    const polyMesh& tgt
)
